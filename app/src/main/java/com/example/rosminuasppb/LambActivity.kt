...
class LambActivity : AppCompatActivity() {
    ...
    private fun getMenuMeal() {
        ...
        val url = "https://www.themealdb.com/api/json/v1/1/filter.php?c=Lamb"
        client.get(url, object : AsyncHttpResponseHandler() {
            ...
            override fun onFailure(
                ...
                Toast.makeText(this@LambActivity , errorMessage, Toast.LENGTH_LONG).show()
            }
