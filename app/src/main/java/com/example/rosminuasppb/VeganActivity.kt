...
class VeganActivity : AppCompatActivity() {
    ...
    private fun getMenuMeal() {
        ...
        val url = "https://www.themealdb.com/api/json/v1/1/filter.php?c=Vegan"
        client.get(url, object : AsyncHttpResponseHandler() {
            ...
            override fun onFailure(
                ...
                Toast.makeText(this@VeganActivity , errorMessage, Toast.LENGTH_LONG).show()
            }
